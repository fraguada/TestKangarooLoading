...
{
    public class TestLoadingKangarooCommand : Command
    {
        public TestLoadingKangarooCommand()
        {
        ...
        public static TestLoadingKangarooCommand Instance
        {
            get; private set;
        }
        ...
        {
            get { return "TestLoadingKangarooCommand"; }
        }
